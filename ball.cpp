...
void Ball::update(sf::RectangleShape R, sf::RectangleShape W1, sf::RectangleShape W2)
{
    if (this->D == 0)
        this->rotation /= 1.01f;
...
void Ball::checkIfWallHit(sf::RectangleShape W1, sf::RectangleShape W2)
{
...
bool Ball::checkIfOnClicked(Ball ball, sf::Vector2i mouseposition)
{
    float mx, my, bx, by;
